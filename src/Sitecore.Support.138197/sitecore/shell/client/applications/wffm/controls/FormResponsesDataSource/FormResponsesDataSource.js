define(["sitecore"], function (Sitecore) {
    var model = Sitecore.Definitions.Models.ControlModel.extend({
        ...
        getReport: function () {
            ...
            $.ajax({
                cache: false,
                type: 'POST',
                url: "/api/sitecore/FormReportsEx/GetFormFieldsStatisticsEx",
                context: this,
    ...
    Sitecore.Factories.createComponent("FormResponsesDataSource", model, view, ".sc-FormResponsesDataSource");
});
